            ...
            <div className="flex flex-col items-start justify-start w-[74%] md:w-full">
              <div className="flex flex-col items-start justify-start w-full">
                ...
                >
                  ...
                  It defines the meaning and structure of web content. Other technologies besides HTML are generally
                  ...
                  or between websites. Links are a fundamental aspect of the Web. By uploading content to the Internet and
                ...
                <Text
                  ...
                  size="txtPublicSansLight18Bluegray600"
                >
                  Can we evenimagine present day internet without html ? 
                </Text>
                <Text
